  ...
  return (
    <form className="space-y-5" onSubmit={onSubmit} noValidate>
      <div className="space-y-2">
        ...
        <h2 className="text-2xl font-semibold tracking-tight">Quên mật khẩu?</h2>
        <p className="text-sm text-muted-foreground">Chúng tôi sẽ gửi liên kết đặt lại an toàn tới email của bạn.</p>
      </div>
